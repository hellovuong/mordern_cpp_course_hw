...
namespace no_strings_attached {
    std::string string_trim::Trim(const std::string &str) {
        return Trim(str, ' ', Side::kBoth);
    }
    std::string string_trim::Trim(const std::string &str, char char_to_trim, string_trim::Side side) {
        if (side == Side::kLeft)
    ...
    std::string string_trim::leftTrim(const std::string &str, char char_to_trim) {
        size_t start = str.find_first_not_of(char_to_trim);
        return (start == std::string::npos) ? "" : str.substr(start);
    }
    std::string string_trim::rightTrim(const std::string &str, char char_to_trim) {
